...
def main():
    # Prompt user for song and artist information
    song_and_artist = input("Enter the song followed by the artist name (e.g. 'Shape of You by Ed Sheeran'): ")
    video_url = input("Please enter the video URL: ")
    # Split the input into song search term and artist name
    song_search_term, artist_name = song_and_artist.split(" by ")
